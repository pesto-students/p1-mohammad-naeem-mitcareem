...
function ArrayToEdge(arrayEdge) {
    ...
    //separating source and destination in different array and calling function addedge on those two array
...
//checking if path exists between sourcec and destination
